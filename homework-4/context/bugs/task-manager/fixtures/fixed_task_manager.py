...
def add_task(tasks, title):
    """Return a new task list containing a validated, normalized title."""
...
def completion_percentage(tasks):
    """Return the percentage of completed tasks, including an empty list."""
    if not tasks:
        return 0.0
...
def render_task_html(task):
    """Render one task for the tiny HTML view with untrusted text escaped."""
